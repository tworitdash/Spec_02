...
% figure(i);
% 
% plot(f*10^(-9), 10*log10(abs(Dir)), 'LineWidth', 2, 'Color',[0.25, 0.25, 0.25]);
% 
% grid on;
% xlabel('frequency(GHz)', 'FontSize', 12, 'FontWeight', 'bold');
% ylabel('Directivity(dB Scale)', 'FontSize', 12, 'FontWeight', 'bold');
% title(['D(\theta = 0, \phi = 0) at \epsilon_r =', num2str(epsilon_r(i))], 'FontSize', 12, 'FontWeight', 'bold');
