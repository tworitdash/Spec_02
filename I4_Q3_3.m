...
Dir(i) = 4 * pi * U(1, 1) ./ P_rad;

end

figure(1);

plot(f*10^(-9), abs(Dir), 'LineWidth', 2, 'Color', [0.6350, 0.0780, 0.1840]);
...
figure(2);
plot(f*10^(-9), 10*log10(abs(Dir)), 'LineWidth', 2, 'Color', [0.6350, 0.0780, 0.1840]);
