...
title(['Active input impedance at \theta_0 = ', num2str(th(j).*180/pi)], 'FontSize', 12, 'FontWeight', 'bold');
legend({'Real Z_{in}','Imag Z_{in}'},'Location','north', 'FontSize', 12, 'FontWeight', 'bold');
