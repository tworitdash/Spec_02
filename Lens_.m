...
plot(theta(91, :)*(180/pi), db(E_abs(91, :)./max(E_abs(91, :))));
...
figure(1)
%plot(theta_obs(1, :)*180/pi, db(E_abs_ap(1, :)./max(E_abs_ap(1, :))));
surface(rho.*cos(phi), rho.*sin(phi), 20*log10(abs(J_x)) , 'linestyle' , 'none' );
figure(2)
surface(rho.*cos(phi), rho.*sin(phi), 20*log10(abs(J_y)) , 'linestyle' , 'none' );
%surf(kx/k0, ky/k0, E_abs);
E_plot = Eth(1, :);
E_max =  max(Eth(1, :));
figure(3);
%plot(theta(1, :)*(180/pi), abs(E_plot./E_max));
%hold on;
plot(theta_obs(1, :)*(180/pi), db(E_abs_ap(1, :)./max(E_abs_ap(1, :))));
hold on;
...
figure(4)
plot(theta_obs(91, :)*(180/pi), db(E_abs_ap(91, :)./max(E_abs_ap(91, :))));
hold on;

plot(theta_obs(91, :)*(180/pi), db(E_abs_airy(91, :)./max(E_abs_airy(91, :))));
