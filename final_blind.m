...
for p=1:size(f, 2)
    ...
    [mx, my] = meshgrid(-100:1:100, -100:1:100);
    %D_inf = zeros(size(mx));
...
%             plot(krho_1, abs(1./D_inf), 'LineWidth', 2);
%             grid on;
            ...
            kx = linspace(k0, ksub, 61);
            krho_1 = sqrt(kx.^2 + ky0.^2);
            
            D = D_inf_func_er(kx0, th(j), ph, w, k0, dy, hd, er);
